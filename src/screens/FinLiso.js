...
class FinAtencion extends Component {
    ...
    componentDidMount() {
        ...
        var lisos = JSON.parse(localStorage.getItem('lisos'));
        this.setState({
            clienteActual: clienteActual, lisos
        })
    }
    ...
    async onPress() {
        await localStorage.setItem('lisos',0);
                ...
                <div style={{ flex: 1, backgroundColor: '#DDDDDD', height: this.state.height }}>
                    ...
                    <div style={styles.scroller}>
                        <div style={styles.correct}>
                            <br></br>
                            <div style={{ fontSize: this.state.height / 30 }}>Ha completado el palet nº 111 con {this.state.lisos} piezas lisas </div>
